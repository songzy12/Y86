...
Instr         rrmovl|cmovle|cmovl|cmove|cmovne|cmovge|cmovg|rmmovl|mrmovl|irmovl|addl|subl|andl|xorl|jmp|jle|jl|je|jne|jge|jg|call|ret|pushl|popl|"."byte|"."word|"."long|"."string|"."pos|"."align|halt|nop|iaddl|leave|wrint|rdint|wrch|rdch
Letter        [a-zA-Z]
Digit         [0-9]
