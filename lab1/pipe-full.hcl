...
intsig IRMEXCHANGE 'I_RMEXCHANGE'
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IRMEXCHANGE, IMRMOVL,
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IRMEXCHANGE, IMRMOVL, 
			IIADDL };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IRMEXCHANGE, IMRMOVL, IJXX, ICALL, 
	IIADDL };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IRMEXCHANGE, IOPL, IPUSHL  } : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IRMEXCHANGE, IMRMOVL  } : D_rB;
...
int d_dstM = [
	D_icode in { IMRMOVL, IRMEXCHANGE, IPOPL } : D_rA;
	D_icode in { ILEAVE } : REBP;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IRMEXCHANGE, IMRMOVL } : E_valC;
	E_icode in { IIADDL } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IRMEXCHANGE, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL } : E_valB;
	E_icode in { IIADDL, ILEAVE } : E_valB;
...
int mem_addr = [
	M_icode in { IRMMOVL, IRMEXCHANGE, IPUSHL, ICALL, IMRMOVL } : M_valE;
...
bool mem_read = M_icode in { IMRMOVL, IRMEXCHANGE, IPOPL, IRET, ILEAVE };

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IRMEXCHANGE, IPUSHL, ICALL };
...
bool F_stall =
	...
	E_icode in { IMRMOVL, IRMEXCHANGE, IPOPL } &&
...
bool D_bubble =
	...
	!(E_icode in { IMRMOVL, IRMEXCHANGE, IPOPL } && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
